...
public class EvaluatingHand : MonoBehaviour {
    ...
    public void StrongestHand(string whichPlayer)
    {
        ...
        if (isStraightFlush == true)
        ...
        }else if (isQuads == true && isStraightFlush == false)
            {
                if (whichPlayer == "Enemy")
                    {
        ...
        }else if (isFullHouse == true && isQuads == false && isStraightFlush == false)
                {
                if(whichPlayer == "Enemy")
                    {
        ...
        }else if (isFlush == true && isFullHouse == false && isQuads == false && isStraightFlush == false)
            {
                if (whichPlayer == "Enemy")
                    {
            ...
            }else if (isStraight == true && isFlush == false && isFullHouse == false && isQuads == false && isStraightFlush == false)
            {
                if(whichPlayer == "Enemy")
                    {
        ...
        }else if (isSet == true && isStraight == false && isFlush == false && isFullHouse == false && isQuads == false && isStraightFlush == false)
            {
                if (whichPlayer == "Enemy")
                    {
        ...
        }else if (isTwoPair == true && isSet == false && isStraight == false && isFlush == false && isFullHouse == false && isQuads == false && isStraightFlush == false)
            {
                if (whichPlayer == "Enemy")
                    {
        ...
        }else if (isPair == true && isTwoPair == false && isSet == false && isStraight == false && isFlush == false && isFullHouse == false && isQuads == false && isStraightFlush == false)
            {
                if (whichPlayer == "Enemy")
                    {
