...
class ReplaceTextForTextMeshPro : EditorWindow
{
    ...
    public static void TextMeshTransmorphSingle(MenuCommand command)
    {
        ...
        TMP_FontAsset newFont = Resources.Load("Fonts/TheBrownies", typeof(TMP_FontAsset)) as TMP_FontAsset;
        if (newFont == null)
        {
        ...
        fontMap.Add("TheBrownies", newFont);


        Font font = currentUIText.font;
        if (font.fontNames[0] != "Brownies")
            return;
