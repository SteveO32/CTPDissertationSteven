...
{
    /*
    [RequireComponent(typeof(FH.LandVehicle))]
    public class HDev_CarResetter : MonoBehaviour
    {
        ...
        private FH.LandVehicle mRef_carController;
        #endregion
        ...
        private void Awake()
        {
            ...
            mRef_carController = GetComponent<FH.LandVehicle>();
        }
        ...
        private void Update()
        {
            ...
            else if (m_shouldRecord && mRef_carController.Grounded)
            {
                //m_positions.push(transform.position);
                m_safePos = transform.position;
                m_shouldRecord = false;
