...
namespace HDev
{
    public class HDev_TerrainPropertyReader : MonoBehaviour
    {
        [SerializeField]
        private HDev_TerrainProperties.Properties_s[] m_properties;
        ...
        public HDev_TerrainPropertyReader()
        {
        ...
        public void GetPropertiesFromRays(RaycastHit[] hits, ref List<HDev_TerrainProperties.Properties_s> properties)
        {
            properties.Clear();
            foreach (var hit in hits)
            {
                HDev_TerrainProperties.Properties_s p = new HDev_TerrainProperties.Properties_s();
        ...
        /// <param name="hits"></param>
        /// <param name="properties"></param>
        public bool GetPropertyFromRay(RaycastHit hit, ref HDev_TerrainProperties.Properties_s property)
        {
            ...
            string name = null;
            if (HDev_TerrainProperties.GetName(renderer.sharedMaterials[materialIdx], ref name))
            {
        ...
        public bool GetProperty(string name, ref HDev_TerrainProperties.Properties_s property)
        {
