...
namespace Kojima
{
    ...
    {
        [System.Serializable]
        public struct VehicalInfo_s
        {
            public float CameraDistance { get; set; }

            //public VehicalInfo_s(float _camDistance)
            //{
       ...
       // Bam.SurfaceParticleScript m_surfParticles;
        ...
        [SerializeField]
        CarInfo_s m_curStats;
        [SerializeField]
        CarInfo_s m_surfaceStats;
        ...
        public VehicalInfo_s m_baseInfo;
        public float ForwardVelocity { get; set; }
        public float NormalisedForwardVelocity { get; set; }
        public float RespawnCounter { get; set; }
