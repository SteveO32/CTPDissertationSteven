...
namespace Bam
{
    public class CarSoundScript : MonoBehaviour
    {
        ...
        void HandleAcceleration()
        {
            ...
            targetAccelerationPitch = Mathf.Clamp(0.8f + (m_myCar.NormalisedForwardVelocity * 0.9f), 0, curGearPitchTarget + 0.1f);
        ...
        void HandleEngine()
        {
            ...
            targetEnginePitch += m_myCar.ForwardVelocity * 0.005f;
