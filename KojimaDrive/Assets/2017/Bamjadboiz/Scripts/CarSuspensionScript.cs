...
namespace Bam
{
    public class CarSuspensionScript : MonoBehaviour
    {
        ...
        /// <summary>
        /// Initialise the Suspesion for Land Vehicles.
        /// </summary>
        /// <param name="newCarBody"></param>
        /// <param name="newStrength"></param>
        /// <param name="carScr"></param>
        public void Initialise(Transform newCarBody, float newStrength, FH.LandVehicle carScr)
        {
            //m_carScr = carScr;
