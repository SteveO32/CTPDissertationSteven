...
public class MyAssetModificationProcessor : UnityEditor.AssetModificationProcessor
{
	...
	[MenuItem("Kojima Drive/Reporter/Create")]
	...
	//			if( !Directory.Exists( Application.dataPath + "/2017/StreamingAssets"))
	//			{
	//				Directory.CreateDirectory( Application.dataPath + "/2017/StreamingAssets");
	//			}
	//			string info_path = Application.dataPath + "/2017/StreamingAssets/build_info.txt";
